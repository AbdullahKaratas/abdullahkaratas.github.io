...
export default function CV() {
  ...
  const t = {
    de: {
      ...
      about: 'Kurzprofil',
      aboutText: 'Enterprise Architect mit Forschungshintergrund in Deep Learning und Neural Networks. Promotion mit Anwendung von Machine Learning für Industrie 4.0. Erfahrung von Cloud-Plattformen bis AI-gestützte Prozessoptimierung.',
    ...
    en: {
      ...
      subtitle: 'Deep Learning · Enterprise Architecture · Cloud Platforms',
      about: 'Profile',
      aboutText: 'Enterprise Architect with a research background in Deep Learning and Neural Networks. PhD research applied machine learning to Industry 4.0 challenges. Experience ranges from cloud platforms to AI-powered process optimization.',
